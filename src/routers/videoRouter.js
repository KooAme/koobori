...
import { edit, upload, deleteVideo } from '../controllers/videoController';
...
videoRouter.get('/:id(\\d+)', see); //:parameter 가 없으면 모든 영상마다 router을 만들어야 함. ':' url안에 변수를 만들 수 있음, ID number
